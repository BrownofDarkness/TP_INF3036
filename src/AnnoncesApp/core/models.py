...
class Modele(models.Model):
    nom = models.CharField(max_length=100, unique=True)
    marque = models.ForeignKey(Marque, on_delete=models.CASCADE, related_name="modele")
...
class Voiture(models.Model):
    ...
    model = models.ForeignKey(Modele, on_delete=models.CASCADE, related_name="voiture")
